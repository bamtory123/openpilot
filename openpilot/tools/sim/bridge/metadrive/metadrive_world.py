...
class MetaDriveWorld(World):
  ...
  def set_control_telemetry(self, steering_cmd_deg, accel_cmd_mps2, applied_throttle, applied_brake,
    ...
    self._control_telemetry = {
      ...
      "model_path_y_20m": model_path_y_20m,
      ...
      "model_path_end_speed_mps": model_path_end_speed_mps,
      "model_valid": model_valid,
      "model_frame_id": model_frame_id,
      "model_frame_age": model_frame_age,
      "model_frame_drop_perc": model_frame_drop_perc,
      "model_execution_time_s": model_execution_time_s,
      "calibration_roll_rad": calibration_rpy_rad[0],
      "calibration_pitch_rad": calibration_rpy_rad[1],
      "calibration_yaw_rad": calibration_rpy_rad[2],
      "calibration_status": calibration_status,
      "model_device_type": model_device_type,
      "model_camera_sensor": model_camera_sensor,
