...
class SimulatedCar:
  ...
  def __init__(self):
    ...
    self.sm = messaging.SubMaster(['carControl', 'controlsState', 'carParams', 'selfdriveState', 'onroadEvents', 'modelV2', 'lateralManeuverPlan', 'extrinsicsCalibration', 'deviceState', 'narrowRoadCameraState'])
